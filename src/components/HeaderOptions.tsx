...
export const HeaderOptions: React.FC<IHeaderOptionsProps> = React.memo(function HeaderOptions({ loadImage, shadersEnabled, setSharesEnabled, cameraControlEnabled, setCameraControlEnabled }) {
