...
export const LayerSelectionComponent: React.FC<ILayerSelectionComponentProps> = ({ onValueChanged, defaultLayer }) => {
    ...
    return (
        <Pivot onLinkClick={onChangeLayer} selectedKey={defaultLayer}>
